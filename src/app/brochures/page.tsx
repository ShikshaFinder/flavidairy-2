...
export default function BrochuresPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-20 pb-12 bg-gradient-to-br from-white via-blue-50/30 to-white">
                        ...
                        <div className="space-y-2">
                          {categoryBrochures.map((brochure) => (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="block p-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-sm transition-all duration-300 group"
                            >
                              <div className="flex items-center justify-between">
              ...
              {brochures.map((brochure, index) => (
                ...
                >
                  <a
                    href={`/${brochure.filename}`}
                    download
                    className="block p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-300 group"
                  >
