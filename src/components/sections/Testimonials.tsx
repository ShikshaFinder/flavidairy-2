  ...
  return (
    <section className="py-8 bg-gradient-to-br from-background-secondary to-background-tertiary">
      <div className="container mx-auto px-4">
        ...
        >
          <Badge className="mb-4 bg-primary/10 text-black border-primary/20">
            Testimonials
          </Badge>
          ...
          <Card className="relative overflow-hidden border-0 shadow-xl">
            <CardContent className="p-8 md:p-12">
              ...
              >
                ...
                <Badge
                  variant="outline"
                  className="ml-auto text-xs border-primary/20 text-primary"
                >
              ...
              >
                <MotionButton
                  ...
                  className="rounded-full w-12 h-12 p-0 border-primary/20 text-primary hover:bg-primary hover:text-white"
